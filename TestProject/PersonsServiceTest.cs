...
public class PersonsServiceTest
{
  ...
  public void GetAllPersons_AddFewPersons()
  {
    ...
    PersonAddRequest person_request_2 = new PersonAddRequest()
    {
      ...
      DateOfBirth = DateTime.Parse("2004-05-10"),
      ReceiveNewsLetters = false
    };
    ...
    PersonAddRequest person_request_3 = new PersonAddRequest()
    {
      ...
      Gender = GenderOptions.Male,
      Address = "address of ratan",
      CountryID = country_response_2.CountryID,
      DateOfBirth = DateTime.Parse("1996-11-01"),
      ReceiveNewsLetters = true
    };
    ...
    // Act
    List<PersonResponse> person_list_from_search = _personsService.GetAllPersons();
  ...
  // First we will add few persons; and then we will search based on person name with some searching string. It should return the matching persons
  [Fact]
  public void GetFilteredPersons_SearchByPersonName()
  {
    ...
    // Act
    List<PersonResponse> person_list_from_search = _personsService.GetFilteredPersons(nameof(Person.PersonName), "ma");
  ...
  public void GetSortedPersons()
  {
    ...
    // Act
    List<PersonResponse> persons_list_from_search = _personsService.GetSortedPersons(allPersons, nameof(Person.PersonName), SortOrderOptions.DESC);
    ...
    {
      Assert.Equal(person_response_list_from_add[i], persons_list_from_search[i]);
    }
  }
