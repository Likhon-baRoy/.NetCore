...
public class PersonResponse
{
  ...
  /// <returns>True/False, indicating whether all person details are matched with the specified parameter object</returns>
...
{
  /// <summary>
  /// An extension method to convert an object pf Person class into PersonResponse class
  /// </summary>
